...
glabel MRDisplayMeshPolys_GT4
	...
	add        $t3, $t3, $a0 # handwritten instruction
.L8007C800:
	lwc2       $0, 0x0($t0)
	lwc2       $1, 0x4($t0)
	lwc2       $2, 0x0($t1)
	...
	lwc2       $4, 0x0($t3)
	lwc2       $5, 0x4($t3)
	addi       $t8, $a2, 0x24 # handwritten instruction
	nop
	RTPT
	lh         $t0, 0x0($t8)
	lh         $t1, 0x2($t8)
	...
	lwc2       $0, 0x0($t2)
	lwc2       $1, 0x4($t2)
	mfc2       $t9, $24 # handwritten instruction
	swc2       $12, 0x8($a3)
	RTPS
	lwc2       $6, 0x20($a2)
	lh         $t2, 0x4($t8)
...
.L8007C88C:
	...
	add        $t7, $t7, $a1 # handwritten instruction
	lwc2       $0, 0x0($t4)
	lwc2       $1, 0x4($t4)
	lwc2       $2, 0x0($t5)
	lwc2       $3, 0x4($t5)
...
.L8007C994:
	...
	addi       $a2, $a2, 0x24 # handwritten instruction
	addi       $a3, $a3, 0x34 # handwritten instruction
	bgtz       $s5, .L8007C800
