...
*	14.08.97	Dean Ashton		MRLoadOverlay now performs FlushCache() while
...
*	-------		----------		------
*	23.05.97	Dean Ashton		Created
*	14.08.97	Dean Ashton		Placed FlushCache() inside critical section
*								as per library reference guidelines.
*
*%%%**************************************************************************/
