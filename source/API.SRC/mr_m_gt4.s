...
.process_next_polygon					
		...
		add	t8,a2,sizeof_MPGT4		; //DELAY: t8 points to next MR_MPRIM_GT4 structure
		nop
...
;		nop
		...
		lwc2	C2_RGB,MPGT4_cvec(a2)		; //DELAY: Load RGB in RTPS delay slot

		lh	t2,MPGT4_p2(t8)			; Fetch next mp_p2
		nop 
		sll	t2,t2,3				; Turn mp_p3 index into SVECTOR offset
...
.clip_polygon:	
		...
		add	t4,t4,a1			; //DELAY: t5 = normal 0 address (always executed in branch slot)
